                ...
                <form action="" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="email" class="form-control" id="pj_email" name="pj_email" >
                    ...
                    <div class="my-3 text-center w-100">
                        <button class="w-100 btn btn-primary profile-button" type="submit" name="submit">Send Verification Code</button>
